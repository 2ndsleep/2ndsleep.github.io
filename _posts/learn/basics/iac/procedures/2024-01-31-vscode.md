...
If you're interesting in learning [Bicep]({% post_url /learn/basics/iac/explainers/2024-01-31-iac-overview %}#iac-tools), do the same thing but search for `bicep` and use the official Microsoft extension.