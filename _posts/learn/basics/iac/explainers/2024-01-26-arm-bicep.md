...
[ARM templates](https://learn.microsoft.com/en-us/azure/azure-resource-manager/templates/overview) allow you to [declaratively]({% post_url /learn/basics/iac/explainers/2024-01-21-iac-principles %}#declarative-code) define and deploy your Azure resources. They are simply JSON files that look like this:
